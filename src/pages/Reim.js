...
<div style={{ height: "100%" }}>
    <Heroes
        bgdesktop={require("/Users/angelocantone/Documents/vgprowiki/src/images/BG/Reim_Desktop.jpg")}
        bgtablet={require("/Users/angelocantone/Documents/vgprowiki/src/images/BG/Reim_Tablet.jpg")}
        bgmobile={require("/Users/angelocantone/Documents/vgprowiki/src/images/BG/Reim_Mobile.jpg")}
        heroname="REIM"
        role='JUNGLE, MAGE'
   ...
   <Models
   bgmodel={require("/Users/angelocantone/Documents/vgprowiki/src/images/BG/Reimblurred.jpg")}
   model={require("/Users/angelocantone/Documents/vgprowiki/src/images/models/Reim.png")}>
   </Models>
    <div className="Title">
    ...
    <div className="SkillboxGroupScroll">
        <div className="SkillboxGroup">
            <Skillbox
                ...
                image='https://jd3sljkvzi-flywheel.netdna-ssl.com/wp-content/uploads/2016/01/Reim_Frostguard_Perk.jpg'
            ...
            <Skillbox
                ...
                image='https://jd3sljkvzi-flywheel.netdna-ssl.com/wp-content/uploads/2016/01/Reim_Glacial_Shard_Ability_A.jpg'
                              />
            <Skillbox
                title="CHILL WINDS"
                                  subtitle="B ABILITY"
                                  image='https://jd3sljkvzi-flywheel.netdna-ssl.com/wp-content/uploads/2016/01/Reim_Chill_Winds_Ability_B.jpg'
            ...
            <Skillbox
                title="VALKYRIE"
                                  subtitle="ULTIMATE"
                                  image='https://jd3sljkvzi-flywheel.netdna-ssl.com/wp-content/uploads/2016/01/Reim_Winter_Valkyrie_Ultimate.jpg'
    ...
    <div className="TalentboxGroupScroll">
        <div className="TalentboxGroup">
            <Talentbox
                ...
                image={require('/Users/angelocantone/Documents/vgprowiki/src/images/Talents/Reim_Rare.png')}
            />
            <Talentbox
                title="Long Winter"
                subtitle="EPIC"
                ...
                image={require('/Users/angelocantone/Documents/vgprowiki/src/images/Talents/Reim_Epic.png')}
            />
            <Talentbox
                title="Revenant"
                subtitle="LEGENDARY"
                ...
                image={require('/Users/angelocantone/Documents/vgprowiki/src/images/Talents/Reim_Legendary.png')}
            />
        </div>
    </div>
    <div className="Title">
    ...
    <div className="SkinboxGroupScroll">
        <div className="SkinboxGroup">
            <Skinbox
                ...
                title="Ice Wind Reim"
                text="Rare"
                image={require('/Users/angelocantone/Documents/vgprowiki/src/images/Skins/Reim_Ice_Wind.png')} />
            <Skinbox
                color="#7A02EA"
                title="Valkyrie Reim"
                text="Epic"
                image={require('/Users/angelocantone/Documents/vgprowiki/src/images/Skins/Reim_Valkyrie.png')} />
            <Skinbox
                color="#FF9000"
                title="North Hammer Reim"
                text="Legendary"
                image={require('/Users/angelocantone/Documents/vgprowiki/src/images/Skins/Reim_North_Hammer.png')} />
            <Skinbox
                color="#6393F9"
                title="Deathless Reim"
                text="Rare"
                image={require('/Users/angelocantone/Documents/vgprowiki/src/images/Skins/Reim_Deathless.png')} />
            <Skinbox
                color="red"
                title="Santa Reim"
                text="Special Edition"
                image={require('/Users/angelocantone/Documents/vgprowiki/src/images/Skins/Reim_Santa.png')} />
            </div>
    </div>
  </div >
  </Layout>
