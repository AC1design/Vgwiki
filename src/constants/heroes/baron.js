export const frontmatter = {
  ...
  stats: [
    ...
    { name: 'H. REGEN', value: '3.29 - 7.91', color: '#4eec8b' },
    { name: 'ENERGY', value: '320 - 765', color: '#5bbcff' },
    { name: 'ENG REGEN', value: '6.67 - 18', color: '#5bbcff' },
    { name: 'WP DAMAGE', value: '71 - 130', color: '#f48596' },
    { name: 'ATK SPD', value: '100% - 111%', color: '#f48596' },
    { name: 'ARMOR', value: '26 - 78', color: '#f6ee71' },
    { name: 'SHIELD', value: '21 - 57', color: '#f6ee71' },
