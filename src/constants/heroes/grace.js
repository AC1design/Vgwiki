export const frontmatter = {
  ...
  stats: [
    ...
    { name: 'H. REGEN', value: '3.72 - 8.34', color: '#4eec8b' },
    { name: 'ENERGY', value: '268 - 653', color: '#5bbcff' },
    { name: 'ENG REGEN', value: '1.92 - 4.23', color: '#5bbcff' },
    { name: 'WP DAMAGE', value: '73 - 152', color: '#f48596' },
    { name: 'ATK SPD', value: '100% - 136.3%', color: '#f48596' },
    { name: 'ARMOR', value: '35 - 100', color: '#f6ee71' },
    { name: 'SHIELD', value: '25 - 75', color: '#f6ee71' },
    { name: 'ATK RANGE', value: '2.7', color: '#e19efb' },
    { name: 'MOVE SPD', value: '4.1', color: '#e19efb' },
  ],
